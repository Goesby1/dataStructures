 ...
 * @see Phonebook
 * @see HashTable
 * @see SeparateChainingHashTables
...
public class StudentTests {
    ...
    @Test
    public void testBehaviorWhenEmptySeparateChaining() {
        CollisionResolver namesToPhones = resolvers[0];
        CollisionResolver phonesToNames = resolvers[0];
    ...
    public void insertionStressTest() {
      ...
      //  assertEquals("LP table: " + lp.toString() + " QP Table: " + qp.toString(),0, 1);
    ...
    public void testLProbes() {
       ...
       // assertEquals("table: " + lp.toString(),0, 1);
    ...
    @Test
    public void testOLProbes() {

        OrderedLinearProbingHashTable lp = new OrderedLinearProbingHashTable(false);

        /*assertEquals(1, lp.put("Jerry","1").getProbes());
        assertEquals(2, lp.put("Tiffany", "894-59-0011").getProbes());
        assertEquals("1table: " + lp.toString(),0, 1);
*/
        assertEquals(1, lp.put("Jessie", "705-12-7500").getProbes());
        assertEquals(2, lp.put("Arnold", "894-59-0011").getProbes());
        assertEquals(1, lp.put("Tiffany", "894-59-0011").getProbes());
        assertEquals(1, lp.put("Mary", "888-1212-3340").getProbes());
...
//        assertEquals("1table: " + lp.toString(),0, 1);
        ...
        assertEquals(1, lp.get("Mary").getProbes());
        /*********************************************** */
       // assertEquals("2table: " + lp.toString(),0, 1);

        // Search fail
        assertEquals(1, lp.get("Jerry").getProbes());
        assertEquals(1, lp.remove("Jerry").getProbes());
        assertEquals(null, lp.remove("Jerry").getValue());

        //assertEquals("3table: " + lp.toString(),0, 1);
    ...
    public void testResizeSoftOLProbes() {
        ...
        OrderedLinearProbingHashTable lp = new OrderedLinearProbingHashTable(true);
...
//        assertEquals("True " + lp.check() +" Loc " + lp.loc()+ ".", 1, lp.capacity());

        assertEquals(" Capacity: " + lp.capacity() + ", Count: " + lp.size() + ", table " + lp.toString(), 0, lp.capacity());
...
//        assertEquals("True " + lp.check() +" Loc " + lp.loc()+ ".", 1, lp.capacity());
    ...
    @Test
    public void testResizeSoftLProbesQuadratic() {
...
//        assertEquals("True " + lp.check() +" Loc " + lp.loc()+ ".", 1, lp.capacity());
 ...
 //      assertEquals("Capacity: " + lp.capacity() + ", Count: " + lp.size() + ", table " + lp.toString(), 0, lp.capacity());
       ...
       assertEquals("After additions and deletions, and additions again, the capacity should be 23, but get " + lp.capacity() + ".", 23, lp.capacity());
        ...
        lp.put("Terry", "new");
        assertEquals("After additions and deletions, and additions again, resize should be triggered and the capacity should be 23, but get " + lp.capacity() + ".", 23, lp.capacity());
